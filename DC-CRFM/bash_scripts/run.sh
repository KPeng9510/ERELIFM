...
############################################### ADM ~ IMNET 256 ###############################################
#accelerate launch --multi_gpu --num_processes 4 train_flow_latent_mnist.py --exp imnet_f8_adm \
#     --dataset imagenet_256 --datadir ./data/imagenet/ --num_classes 6 \
#     --batch_size 64 --num_epoch 1200 --label_dim 1000 \
#     --image_size 32 --f 8 --num_in_channels 4 --num_out_channels 4 \
#     --nf 256 --ch_mult 1 2 3 4 --attn_resolution 16 8 4 --num_res_blocks 2 \
...
############################################### DiT-B/2 ~ IMNET 256 ###############################################
 accelerate launch --multi_gpu --num_processes 4 train_flow_latent_domainnet.py --exp bed_f8_adm \
     --dataset lsun_bedroom --datadir data/lsun/ \
     --batch_size 16 --num_epoch 500 \
     --image_size 256 --f 8 --num_in_channels 4 --num_out_channels 4 \
     --nf 256 --ch_mult 1 2 3 4 --attn_resolution 16 8 4 --num_res_blocks 2 \
     --lr 1e-4 --scale_factor 0.18215 --no_lr_decay \
     --save_content --save_content_every 2 \
