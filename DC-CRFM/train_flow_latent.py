...
def train(args):
    ...
    f = open('path/to/index_'+target_domain[0]+'_0_5.pkl', 'rb+')
    indexes = pkl.load(f)
    f.close()
    ...
    exp = args.exp
    parent_dir = "./DiT_l_scala_saved_info_resnet_residual_"+target_domain[0]+"_0_5/latent_flow/{}".format(args.dataset)
