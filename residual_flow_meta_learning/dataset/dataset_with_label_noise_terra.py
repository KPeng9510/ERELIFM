...
class MultiDomainData(Dataset):
    def __init__(self, root_dir, domain, classes,nsr,asymetric=False,all_classes=['dog', 'elephant', 'giraffe', 'horse', 'guitar', 'house'],transform2=None, domain_class_dict=None, train=False, get_domain_label=True, get_classes_label=True, transform=None, loader=default_loader, simclr_transform=None):          
        ...
        if train == True:
            if asymetric == False:
                if nsr == 0.8:
                    file_name = "/hkfs/work/workspace/scratch/fy2374-got/workspace/ijcai_folders/Neurips/benchmarks_noisy_label_osdg/terra_symetric_snr_0_8.pkl"
                if nsr == 0.5:
                    file_name = "/hkfs/work/workspace/scratch/fy2374-got/workspace/ijcai_folders/Neurips/benchmarks_noisy_label_osdg/terra_symetric_snr_0_5.pkl"
                if nsr == 0.2:
                    file_name = "/hkfs/work/workspace/scratch/fy2374-got/workspace/ijcai_folders/Neurips/benchmarks_noisy_label_osdg/terra_symetric_snr_0_2.pkl"
            else:
                file_name = "/hkfs/work/workspace/scratch/fy2374-got/workspace/ijcai_folders/Neurips/benchmarks_noisy_label_osdg/terra_asymetric_snr_0_5.pkl"
    ...
    def __getitem__(self, index):
        ...
        if self.train == True:
            return orin_img,img2, label, label_orin, target, index, [path]
        else:
            return orin_img, label, label_orin, target, torch.Tensor(index)
...
if __name__ == '__main__':
    ...
    domain_list = ["location_100",  "location_38",  "location_43",  "location_46"]
    class_list = ["bird",  "bobcat" , "cat",  "coyote" , "dog" , "empty", "opossum"  ,"rabbit" ] #"raccoon" # "squirrel"
    pre_set_snr = 0.5
    all_labels = {}
    ###########################
    ...
    '''for domain in domain_list:
        ...
        for c, category in enumerate(class_list):
            dataset = SingleClassData_2(root_dir='/hkfs/work/workspace/scratch/fy2374-got/workspace/ijcai_folders/Neurips/DomainBed/domainbed/data/terra_incognita_train/', domain=domain, classes=category,  classes_label=c)
            symetric_labels = []
    ...
    import pickle as pkl
    f = open('/hkfs/work/workspace/scratch/fy2374-got/workspace/ijcai_folders/Neurips/benchmarks_noisy_label_osdg/terra_symetric_snr_0_8.pkl', 'wb')
    ...
    for domain in domain_list:
        single_domain_labels = []
        for c, category in enumerate(class_list):
            dataset = SingleClassData(root_dir='/hkfs/work/workspace/scratch/fy2374-got/workspace/ijcai_folders/Neurips/DomainBed/domainbed/data/terra_incognita_train/', domain=domain, classes=category,  classes_label=c, train=False, nsr=0)
            symetric_labels = []
        ...
        all_labels[domain] = single_domain_labels
    import pickle as pkl
    f = open('/hkfs/work/workspace/scratch/fy2374-got/workspace/ijcai_folders/Neurips/benchmarks_noisy_label_osdg/terra_asymetric_snr_0_5.pkl', 'wb')
    pkl.dump(file=f, obj=all_labels)
    f.close()